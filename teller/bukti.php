...
<body onload="window.print()"  style="color: black;font-family: Myriad Pro Light" >
	<table style="background: url('../images/logo3.png') center no-repeat;
		...
		<tr>
			...
			<td align="left">:</td>
			<td align="left"><?php $aksi->rupiah($pembayaran['total']) ?></td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="6" align="center" style="color: black;font-family: Myriad Pro Light">PT. HEMAT ENERGYY/<?php echo $_SESSION['nama_teller']."/".$pembayaran['waktu_pembayaran']; ?></td>
		</tr>
	</table>
</body>
</html>